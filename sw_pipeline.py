...
def sw_pipeline():
	...
	eventification_stage = ProcessStage(
		name = "Eventification",
		input_size = [(256, 256, 1), (256, 256, 1)],
	...
	conv2d_2_stage = DNNProcessStage(
		name = "Conv2D_2",
		op_type = "Conv2D",
		ifmap_size = [128, 128, 4],
		kernel_size = [3, 3, 4, 16],
		stride = 2
	)
	...
	input_data = PixelInput((256, 256, 1), name="CurrInput")
	sw_stage_list.append(input_data)
	prev_input_data = PixelInput((256, 256, 1), name="PrevInput")
	...
	# conv2d_3_stage = conv2d_3_stage.flatten()
